...
time python src_jittor/gpt2_beam.py \
    ...
    --eval_len 64 \
    --model_card gpt2.md \
    --init_checkpoint ./trained_models_jittor/GPT2_M/webnlg_challenge_2017/model.2500.pt \
    --platform local \
    --lora_dim 4 \
    --lora_alpha 32 \
    --beam 10 \
...
python src_jittor/gpt2_decode.py \
    --vocab ./vocab \
    --sample_file ./trained_models_jittor/GPT2_M/webnlg_challenge_2017/predict.2500.b10p08r4.jsonl \
