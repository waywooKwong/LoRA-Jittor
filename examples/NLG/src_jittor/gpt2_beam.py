        ...
        for idx, data in enumerate(data_iter):
            ...
            with jt.no_grad():
                for i in range(0, args.eval_len):
                    ...
                    ##_prob, _w_idx = jt.topk(softmax_probs, num_beams) # batch_size, beam
            ...
            with jt.no_grad():
                # Debug: no distrobuted_gather in Jiitor
...
if __name__ == '__main__':
    ...
    # valid_sampler = jt.utils.data.distributed.DistributedSampler(valid_data)
    ...
    if args.init_checkpoint is not None:
        ...
        # cp = jt.load(args.init_checkpoint, map_location=jt.device('cpu'))
